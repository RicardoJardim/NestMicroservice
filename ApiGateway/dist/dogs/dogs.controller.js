...
let DogsController = class DogsController {
    ...
    async findSingle(prodId) {
        return await this.dogService.getQueryDog(prodId);
    }
    async addOne(completeBody) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], DogsController.prototype, "findSingle", null);
__decorate([
    common_1.Post(),
    ...
    __metadata("design:returntype", Promise)
], DogsController.prototype, "addOne", null);
__decorate([
    common_1.Patch(':id'),
    __param(0, common_1.Param('id', common_1.ParseIntPipe)),
    ...
    __metadata("design:returntype", Promise)
], DogsController.prototype, "changeSingle", null);
__decorate([
    common_1.Delete(':id'),
    __param(0, common_1.Param('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], DogsController.prototype, "deleteSingle", null);
